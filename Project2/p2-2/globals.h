...
extern char guessLetters[6];
extern char* goalWord;
extern char secretLetters[6];
extern int arrayIndex;
extern int position;
extern int lastpushed;
extern char correctLetter[6];
extern int roundCount;
extern int rowCount;
extern int wordEqual;
extern int correctCount;
extern int correctIndex;
extern int found;
extern int reset;
extern float leaderBoard[30];
